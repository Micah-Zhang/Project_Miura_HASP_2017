...
def main():
    ##################################################################MICAH
    #################################################################if you want the cycle number to always be pulled from this thread to the downlink then we need the
